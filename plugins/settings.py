...
#===============================================================#
# HELPER: BUILD SETTINGS PAGE 1 MESSAGE + MARKUP (DRY PRINCIPLE)
#===============================================================#
...
#===============================================================#
# 🚀 CORE TEXT COMMAND ROUTER FOR /SETTINGS
#===============================================================#
...
#===============================================================#
# HIGH-PRIORITY CORE CALLBACK MODULES (GLOBAL NAVIGATION)
#===============================================================#
...
#===============================================================#
# PAGE 1: CORE BOT SETTINGS PANEL CALLBACK
#===============================================================#
...
async def settings_page_2(client, query):
    ...
    msg = (
        ...
        f"›› <b>ᴘʀᴏᴛᴇᴄᴛ ᴄᴏɴᴛᴇɴᴛ:</b> <code>{'✓ ᴛʀᴜᴇ' if client.protect else '✗ ꜰᴀʟsᴇ'}</code>\n"
        f"›› <b>ᴅɪsᴀʙʟᴇ ʙᴜᴛᴛᴏɴ:</b> <code>{'✓ ᴛʀᴜᴇ' if client.disable_btn else '✗ ꜰᴀʟsᴇ'}</code>\n\n"
        f"<blockquote><u><b>≡ 1sᴛ sʜᴏʀᴛᴇɴᴇʀ sᴇᴛᴛɪɴɢs:</b></u></blockquote>\n"
        ...
        f"<blockquote><u><b>≡ 2ɴᴅ sʜᴏʀᴛᴇɴᴇʀ sᴇᴛᴛɪɴɢs:</b></u></blockquote>\n"
        ...
        f"<blockquote><u><b>≡ 3ʀᴅ sʜᴏʀᴛᴇɴᴇʀ sᴇᴛᴛɪɴɢs:</b></u></blockquote>\n"
...
async def manage_shortners(client, query):
    ...
    msg = (
        f"<blockquote>✦ ᴍᴜʟᴛɪ-sʜᴏʀᴛᴇɴᴇer ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ᴘᴀɴᴇʟ</blockquote>\n\n"
        f"›› <b>1sᴛ:</b> <code>{getattr(config, 'SHORT_URL_1', 'None')}</code> [<code>{'✔️ ᴏɴ' if getattr(config, 'SHORT_STATUS_1', True) else '❌ ᴏꜰꜰ'}</code>]\n"
        f"›› <b>2ɴᴅ:</b> <code>{getattr(config, 'SHORT_URL_2', 'None')}</code> [<code>{'✔️ ᴏɴ' if getattr(config, 'SHORT_STATUS_2', True) else '❌ ᴏꜰꜰ'}</code>]\n"
        f"›› <b>3ʀᴅ:</b> <code>{getattr(config, 'SHORT_URL_3', 'None')}</code> [<code>{'✔️ ᴏɴ' if getattr(config, 'SHORT_STATUS_3', True) else '❌ ᴏꜰꜰ'}</code>]\n\n"
        f"<b>ᴄʜᴏᴏsᴇ sʜᴏʀᴛɴᴇer ʙᴇʟᴏᴡ ᴛᴏ ᴄʜᴀɴɢᴇ ɪᴛs sᴇᴛᴛɪɴɢs, sᴡɪᴛᴄʜ sᴛᴀᴛᴜs ᴏʀ ʀᴜɴ ᴀ ᴛᴇsᴛ sʜᴏʀᴛᴇɴ!</b>"
    )
...
async def edit_specific_shortner(client, query):
    ...
    msg = (
        f"<blockquote>🛠️ ᴄᴏɴꜰɪɢᴜʀᴇ sʜᴏʀᴛᴇɴᴇer {num}</blockquote>\n"
        f"›› <b>sᴛᴀᴛᴜs:</b> <code>{'✔️ ᴀᴄᴛɪᴠᴇ / ᴏɴ' if status_val else '❌ ɪɴᴀᴄᴛɪᴠᴇ / ᴏꜰꜰ'}</code>\n"
        f"›› <b>ᴄᴜʀʀᴇɴᴛ ᴜʀʟ:</b> <code>{url_val}</code>\n"
        f"›› <b>ᴄᴜʀʀᴇɴᴛ ᴛᴜᴛᴏʀɪᴀʟ:</b> <code>{tut_val}</code>\n\n"
        f"<b>ᴍᴀɴᴀɢᴇ sᴡɪᴛᴄʜ, ᴜᴘᴅᴀᴛᴇ ᴘᴀʀᴀᴍᴇᴛᴇʀs ᴏʀ ᴛᴇsᴛ ᴀᴘɪ ᴄᴏɴɴᴇᴄᴛɪᴠɪᴛʏ:</b>"
    )

    status_text = "❌ ᴅɪsᴀʙʟᴇ / ᴛᴜʀɴ ᴏꜰꜰ" if status_val else "✔️ ᴇɴᴀʙʟᴇ / ᴛᴜʀɴ ᴏɴ"
...
async def process_shortner_inputs(client, query):
    ...
    field_names = {
        "url": "sʜᴏʀᴛɴᴇer ᴍᴀɴᴀɢᴇ ᴅᴏᴍᴀɪɴ",
        "api": "ᴀᴘɪ ᴛᴏᴋᴇɴ ᴋᴇʏ",
        "tut": "ᴛᴜᴛᴏʀɪᴀʟ ᴠɪᴅᴇᴏ ʟɪɴᴋ"
    }
    examples = {
        "url": "gplinks.com",
        "api": "540e6d65d2851a9c645d...",
        "tut": "https://t.me/How_To_Open_Shortners"
    }

    msg = (
        f"<b>📥 ᴜᴘᴅᴀᴛᴇ {field_names[field]} ꜰᴏʀ sʜᴏʀᴛᴇɴᴇer {num}</b>\n\n"
        f"<b>sᴇɴᴅ ᴛʜᴇ ɴᴇᴡ ᴠᴀʟᴜᴇ ɪɴ ᴛʜᴇ ɴᴇxᴛ 60 sᴇᴄᴏɴᴅs!</b>\n\n"
    ...
    try:
        ...
        await query.message.edit_text(
            f"<blockquote><b>✓ sʜᴏʀᴛᴇɴᴇer {num} {field.upper()} ᴜᴘᴅᴀᴛᴇᴅ sᴜᴄᴄᴇssꜰᴜʟʟʏ!</b></blockquote>\n\n"
            f"›› <b>ɴᴇᴡ ᴠᴀʟᴜᴇ:</b> <code>{new_value}</code>",
        ...
        await query.message.edit_text(
            "<blockquote><b>✗ ᴛɪᴍᴇᴏᴜᴛ! ʏᴏᴜ ᴅɪᴅ ɴᴏᴛ sᴇɴᴅ ᴀɴʏ ᴛᴇxᴛ ᴡɪᴛʜɪɴ 60 sᴇᴄᴏɴᴅs.</b></blockquote>",
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton('‹ ʙᴀᴄᴋ', f'edit_short_{num}')]])
        )
...
async def test_shortner_connectivity(client, query):
    ...
    try:
        # Temporarily swap client shortner config for test
        ...
        if test_link and test_link.startswith("http"):
            msg = (
                f"<blockquote><b>✓ ᴛᴇsᴛ sᴜᴄᴄᴇssꜰᴜʟʟʏ ᴘᴀssᴇᴅ!</b></blockquote>\n\n"
                f"›› <b>sʜᴏʀᴛᴇɴᴇer {num} ɪs ᴡᴏʀᴋɪɴɢ ᴘᴇʀꜰᴇᴄᴛʟʏ!</b>\n"
                f"›› <b>ɢᴇɴᴇʀᴀᴛᴇᴅ ʟɪɴᴋ:</b> {test_link}"
            )
        else:
            msg = (
                f"<blockquote><b>✗ ᴛᴇsᴛ ꜰᴀɪʟᴇᴅ!</b></blockquote>\n\n"
                f"›› sʜᴏʀᴛᴇɴᴇer ᴡᴇʙsɪᴛᴇ ʀᴇᴛᴜʀɴᴇᴅ ᴀɴ ɪɴᴠᴀʟɪᴅ ʀᴇsᴘᴏɴsᴇ. ᴄʜᴇᴄᴋ ᴀᴘɪ ᴛᴏᴋᴇɴ sʏɴᴛᴀx."
            )
    except Exception as e:
        msg = (
            f"<blockquote><b>✗ ᴄᴏɴɴᴇᴄᴛɪᴏɴ ᴇʀʀᴏʀ!</b></blockquote>\n\n"
...
async def fsub(client, query):
    if client.fsub_dict:
        ...
        for channel_id, channel_data in client.fsub_dict.items():
            ...
            request_status = "✓ ꜰsᴜʙ" if channel_data[2] else "✗ ꜰsᴜʙ"
        ...
        channels_display = "<i>ɴᴏ ꜰᴏʀᴄᴇ sᴜʙsᴄʀɪᴘᴛɪᴏɴ ᴄʜᴀɴɴᴇʟs ᴄᴏɴꜰɪɢᴜʀᴇᴅ</i>"

    msg = (
        f"<b>◍ ꜰᴏʀᴄᴇ sᴜʙsᴄʀɪᴘᴛɪᴏɴ sᴇᴛᴛɪɴɢs</b>\n\n"
        f"›› <b>ᴄᴏɴꜰɪɢᴜʀᴇᴅ ᴄʜᴀɴɴᴇʟs:</b>\n{channels_display}\n\n"
        f"<b>ᴜsᴇ ᴛʜᴇ ᴀᴘᴘʀᴏᴘʀɪᴀᴛᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ ᴛᴏ ᴍᴀɴᴀɢᴇ ʏᴏᴜʀ ꜰᴏʀᴄᴇ sᴜʙsᴄʀɪᴘᴛɪᴏɴ ᴄʜᴀɴɴᴇʟ ʙᴀsᴇᴅ ᴏɴ ʏᴏᴜʀ ɴᴇᴇᴅs!</b>"
    )
    reply_markup = InlineKeyboardMarkup([
